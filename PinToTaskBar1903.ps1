...
#
# This script is intended purely to allow scriptable pinnign of icons to the user's TaskBar in Windows 10 1903.
# It may work on older versions of windows 10 but is untested.
# There is no pinning to the Start Menu available in this script as Microsoft have further removed access to the APIs via scripting.
# This will only work for english language versions of Windows.  If you want it to work in another language change the values of the two verb actions to your required language.
# taskbarpin / taskbarunpin
# This script works purely as a result of work from found here on GitHub (User b33f / Fuzzy Security)
...
#
# Version 0.1 - 27.05.2019 - Initial release
#
# Stuart Pearson
...
if ($args.count -eq 2){
	...
	write-host "Incorrect number of arguments ({$args.count}), 2 required.  Exiting..."`r`n
	Break
}
